...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <div class="container">
        <h2>Hallo! Bitte loggen Sie sich ein, <br><b><span class="glyphicon glyphicon-th-large"></span> $t34!t</b>
        </h2>
        <hr>
        <style>
          body {
      ...
      <form action method="get">
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><span class="glyphicon glyphicon-qrcode"></span> Passwort :
            </span>
            <input type="password" placeholder="" class="form-control" name="pass" autofocus="" requi#9b0740="">
          </div>
        </div>
        <button type="submit" style="width: 100%;" class="btn btn-success" name="submit"><span class="glyphicon glyphicon-object-align-right"></span> Melden Sie sich bei meiner Zone an <span class="glyphicon glyphicon-object-align-left"></span>
        </button>
      </form>
      <hr>
      <footer>
        <p class="text-center">Copyright &copy; 2019 | 
          $t34!t for this CopyRight and d$t34!t for marketing purpose only
          </a>
        </p>
      </footer>
      </div>
...
<BODY>
<center>
<h1><center><font color="#9b0740">Welcome back <a href="mailto: $t34!t">$t34!t</a></center></h1>
